...
const TabSwitcher = ({ tab, isFilterTab, isActive, handleClick }) => {
  const snap = useSnapshot(state)
  const activeStyles = isActive && isFilterTab ? { backgroundColor: snap.color, opacity: 0.5 } : { backgroundColor: "transparent", opacity: 1 }
  return (
